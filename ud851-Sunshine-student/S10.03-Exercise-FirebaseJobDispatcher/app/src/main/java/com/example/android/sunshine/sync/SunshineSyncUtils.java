...
public class SunshineSyncUtils {
    ...
    private static final int SYNC_SUNSHINE_SECONDS = (int)
            (TimeUnit.HOURS.toSeconds(SYNC_SUNSHINE_HOURS));
    private static final int SYNC_FLEXTIME_SECONDS = SYNC_SUNSHINE_SECONDS/3;
    private static boolean sInitialized;

    //   (11) Add a sync tag to identify our sync job
    private static final String SYNC_SUNSHINE_TAG = "sync_sunshine_tag";
    ...
    synchronized public static void schedulePeriodicWeatherSync(Context context) {
        ...
        Job job = jobDispatcher.newJobBuilder()
                 ...
                 */
                .setRecurring(true)
                .setTrigger(Trigger.executionWindow(SYNC_SUNSHINE_SECONDS, SYNC_SUNSHINE_SECONDS + SYNC_FLEXTIME_SECONDS))
