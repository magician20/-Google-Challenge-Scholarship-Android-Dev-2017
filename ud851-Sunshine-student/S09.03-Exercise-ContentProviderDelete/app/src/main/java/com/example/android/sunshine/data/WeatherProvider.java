...
//   TODO (3) Return the number of rows deleted
        SQLiteDatabase db = mOpenHelper.getWritableDatabase(); // Gets the data repository in write mode
        int numRowDelete = 0;
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case CODE_WEATHER:
                ...
                numRowDelete = db.delete(WeatherContract.WeatherEntry.TABLE_NAME,
                        null,
                        null);
                break;
