...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        String locationValue = sharedPreferences.getString(context.getResources().getString((R.string.pref_location_key)),
    ...
    public static boolean isMetric(Context context) {
        ...
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
      String metricValue  =context.getResources().getString(R.string.pref_units_metric);
        String unitValue = sharedPreferences.getString(context.getResources().getString(R.string.pref_units_key),
                metricValue);
        if(unitValue.equals(metricValue)){
            return true;
        }else{
            return false;
        }
