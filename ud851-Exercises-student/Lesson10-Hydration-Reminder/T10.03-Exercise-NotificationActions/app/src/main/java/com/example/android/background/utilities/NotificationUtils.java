...
public class NotificationUtils {
    ...
    private static final int ACTION_INCREMENT_PENDING_INTENT_ID = 2;
    ...
    public static Notification.Action ignoreReminderAction(Context context) {
        ...
        PendingIntent ignoreReminderIntent = PendingIntent.getActivity(
                context,
                ACTION_IGNORE_PENDING_INTENT_ID,
                intent,
                PendingIntent.FLAG_UPDATE_CURRENT);
        //  (9) Create an Action for the user to ignore the notification (and dismiss it)
        Notification.Action ignoreReminderAction = new Notification.Action
                (R.drawable., "No,Thanks", ignoreReminderIntent);
        //  (10) Return the action
        return ignoreReminderAction;
    }

    //   (11) Add a static method called drinkWaterAction
    public static Notification.Action drinkWaterAction(Context context) {
        ...
        PendingIntent incrementReminderIntent = PendingIntent.getActivity(
                context,
                ACTION_INCREMENT_PENDING_INTENT_ID,
                intent,
                PendingIntent.FLAG_UPDATE_CURRENT);
        //   (15) Create an Action for the user to tell us they've had a glass of water
        Notification.Action incrementReminderAction = new Notification.Action
                (R.drawable., "I did it!", incrementReminderIntent);
        //    (16) Return the action
        return incrementReminderAction;
    }
