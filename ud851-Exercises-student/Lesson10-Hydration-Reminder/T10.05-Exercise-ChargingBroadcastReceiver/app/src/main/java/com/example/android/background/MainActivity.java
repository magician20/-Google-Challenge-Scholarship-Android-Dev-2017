...
public class MainActivity extends AppCompatActivity implements
    ...
    private ChargingBroadcastReceivere mChargingReceivere;
    private IntentFilter mFilterReceiver;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // and an IntentFilter
        mChargingReceivere= new ChargingBroadcastReceivere();
        mFilterReceiver = new IntentFilter(Intent.ACTION_POWER_CONNECTED);
        ...
        mFilterReceiver.addAction(Intent.ACTION_POWER_DISCONNECTED);
    ...
    protected void onResume() {
        super.onResume();
        registerReceiver(mChargingReceivere, mFilterReceiver);
    }
    ...
    protected void onStop() {
        super.onStop();
        unregisterReceiver(mChargingReceivere);
    }
    ...
    private class ChargingBroadcastReceivere extends BroadcastReceiver {
