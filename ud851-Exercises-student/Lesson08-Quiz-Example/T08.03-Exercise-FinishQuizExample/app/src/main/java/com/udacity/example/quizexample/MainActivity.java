...
public class MainActivity extends AppCompatActivity {
    ...
    private void getDataFromCursor() {
        int indexWord = mData.getColumnIndexOrThrow(DroidTermsExampleContract.COLUMN_WORD);
        int indexDefinition = mData.getColumnIndexOrThrow(DroidTermsExampleContract.COLUMN_DEFINITION);
        String word = mData.getString(indexWord);
        String definition = mData.getString(indexDefinition);
        mWord.setText(word);
