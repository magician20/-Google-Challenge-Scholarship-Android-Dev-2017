...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        java.text.SimpleDateFormat formatter = new java.text.SimpleDateFormat(getString(R.string.timeFormat), Locale.getDefault());
        ...
        long minutesLessHoursUntilBoarding = minutesUntilBoarding
