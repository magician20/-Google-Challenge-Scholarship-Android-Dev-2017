...
public class TaskContentProvider extends ContentProvider {
    ...
    // and related ints (101, 102, ..) for items in that directory.
        ...
        public static final int CODE_TASK_WITH_ID=100;
    ...
    public  static UriMatcher buildUriMatcher(){
        ...
        uriMatcher.addURI(TaskContract.AUTHORITY,TaskContract.PATH_TASKS,CODE_TASKS);
        uriMatcher.addURI(TaskContract.AUTHORITY,TaskContract.PATH_TASK_WITH_ID,CODE_TASK_WITH_ID);
        return uriMatcher;
    }
