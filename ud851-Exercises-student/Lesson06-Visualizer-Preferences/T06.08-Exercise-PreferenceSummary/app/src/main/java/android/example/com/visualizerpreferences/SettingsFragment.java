...
public class SettingsFragment extends PreferenceFragmentCompat implements OnSharedPreferenceChangeListener {
    ...
    public void onCreatePreferences(Bundle bundle, String s) {
        ...
        for(int i=0;i<count;i++) {
            ...
            if (!(preference instanceof CheckBoxPreference)) {
                String value = sharedPreferences.getString(preference.getKey(), "");// return red/blue/green
    ...
    private void setPreferenceSummary(Preference preference, String value) {
        if (preference instanceof ListPreference) {
            ...
            int indexOfValue = listPreference.findIndexOfValue(value);// index of value in values array
            if (indexOfValue >= 0) {
                CharSequence[] entries = listPreference.getEntries();//labels array
                //use index to get the label
                listPreference.setSummary(entries[indexOfValue]);//same as(listPreference.getEntries()[indexOfValue])
            }
        }
    }
