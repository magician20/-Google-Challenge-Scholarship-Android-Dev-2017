...
public class VisualizerActivity extends AppCompatActivity
    ...
    private void loadSizeFromSharedPreferences(SharedPreferences sharedPreferences) {
        float minSize = 1;
        String stringSizeValue = sharedPreferences.getString(getString(R.string.pref_size_key),
                getString(R.string.pref_size_default));
        if (!TextUtils.isEmpty(stringSizeValue.trim())) {
            minSize = Float.parseFloat(stringSizeValue);
        }
